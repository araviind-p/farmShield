            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img
                        ...
                        alt="Logo"
                    />
                    <span className="self-center text-2xl font-semibold text-white">FarmShield</span>
                </Link>
                <button
                    onClick={toggleMenu}
                    type="button"
                            ...
                            (link.name !== 'Dashboard' || isAuthenticated) && (
                                <li key={link.name}>
                                    <Link
                                        ...
                                        className={`block py-2 px-3 rounded ${activeLink === link.name
                        ...
                        {!isAuthenticated && (
                            <li>
                                <Link
                                    ...
                                    className={`block py-2 px-3 rounded ${activeLink === 'Login'
                                        ? 'text-white bg-blue-700 md:bg-transparent md:text-blue-500'
                                        : 'text-gray-400 hover:bg-gray-700 md:hover:text-blue-500'
                                        }`}
                                >
